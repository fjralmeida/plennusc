...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-main">
        ...
        <strong>
            <asp:Label ID="lblUsuarioConfirmacao" runat="server"></asp:Label></strong>
            ...
            <span class="tab-sync-count">
                <asp:Label ID="lblQtdAbaNovas" runat="server">0</asp:Label></span>
                            </button>
                            <button type="button" class="tab-sync-btn tab-alteracoes" id="tabBtnAlteracoes" onclick="trocarAbaSync('alteracoes')">
                                <i class="bi bi-arrow-repeat"></i>
                                Alterações
            <span class="tab-sync-count">
                <asp:Label ID="lblQtdAbaAlteracoes" runat="server">0</asp:Label></span>
                            </button>
                        </div>
            ...
            ainda <strong>não foram importadas</strong> para esta base.
                            ...
                            <div class="barra-selecao">
                                ...
                                <span>
                                    <strong>
                                        <asp:Label ID="lblQtdSelecionadas" runat="server">0</asp:Label></strong>
            ...
            possui valores diferentes. Marque as que deseja atualizar.
                            ...
                            <div class="barra-selecao">
                                ...
                                <span>
                                    <strong>
                                        <asp:Label ID="lblQtdSelecionadasUpdate" runat="server">0</asp:Label></strong>
                                    operadora(s) selecionada(s)
                                </span>
                            </div>
