...
using Plennusc.Core.SqlQueries.SqlQueriesMedic.settingsMedic;
using System;
...
{
    public partial class privacySettingsMedic : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    PrivacySettingsMedic settings = new PrivacySettingsMedic();
        ...
        protected void btnAlterarLogin_Click(object sender, EventArgs e)
        {
            ...
            PrivacySettingsMedic settingsConsultationLogin = new PrivacySettingsMedic();
        ...
        protected void btnAlterarSenha_Click(object sender, EventArgs e)
        {
            ...
            PrivacySettingsMedic passwordSettings = new PrivacySettingsMedic(); // Classe de consulta/atualização
