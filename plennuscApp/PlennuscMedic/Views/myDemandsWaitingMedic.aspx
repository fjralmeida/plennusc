<%@ Page Title="" Language="C#" MasterPageFile="~/PlennuscMedic/Views/Masters/Index.Master" AutoEventWireup="true" CodeBehind="myDemandsWaitingMedic.aspx.cs" Inherits="appWhatsapp.PlennuscMedic.Views.myDemandsWaitingMedic" %>
...
.filter-section {
 ...
 .col-acoes {
    width: 160px;          /* largura fixa suficiente */
    min-width: 150px;
    text-align: center;    /* centraliza */
    white-space: normal;   /* permite quebra */
}
   .col-acoes .btn-aprovar,
.col-acoes .btn-action {
    display: block;        /* cada botão ocupa 1 linha */
    width: 100%;           /* ocupa toda a largura da célula */
    margin: 4px 0;         /* espaçamento vertical */
}
    ...
    @media (max-width: 768px) {
        ...
        .col-acoes {
            width: 150px;
            min-width: 140px;
            text-align: center; /* 👉 mobile centraliza */
        }
