...
namespace appWhatsapp.PlennuscFinance.Views.Masters  
{
    public partial class Index : System.Web.UI.MasterPage
    {
        ...
        private HtmlGenericControl CriarMenuComSubmenus(DataRow menu, DataRow[] subMenus, DataTable todosMenus)
        {
            int codMenu = Convert.ToInt32(menu["CodMenu"]);
            string nomeDisplay = menu["NomeDisplay"].ToString();
            string icone = ObterIconeFinance(menu);
        ...
        private string ObterIconeFinance(DataRow menu)
        {
            ...
            //// ✅ FINANCEIRO/CAIXA
            //if (nomeObjeto.Contains("finance") || nomeDisplay.Contains("financeiro"))
            //    return "bi bi-cash-stack me-2";
        ...
        private void ConfigurarUsuario()
        {
            ...
            lblNomeSistema.Text = Session["NomeEmpresa"]?.ToString() ?? "Finance";
        ...
        private void CarregarAvatarUsuario()
        {
            if (Session["CodUsuario"] != null)
            {
                ...
                string defaultAvatar = ResolveUrl("~/public/uploadfinance/images/imgDefultAvatar.jpg");
                ...
                if (pessoa != null)
                {
                    ...
                    {
                        fotoUrl = ResolveUrl("~/public/uploadfinance/images/" + foto);
                    }
                }
