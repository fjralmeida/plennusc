...
using Plennusc.Core.SqlQueries.SqlQueriesFinance.settingsFinance;
using System;
...
{
    public partial class privacySettingsFinance : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    PrivacySettingsFinance settings = new PrivacySettingsFinance();
        ...
        protected void btnAlterarLogin_Click(object sender, EventArgs e)
        {
            ...
            PrivacySettingsFinance settingsConsultationLogin = new PrivacySettingsFinance();
        ...
        protected void btnAlterarSenha_Click(object sender, EventArgs e)
        {
            ...
            PrivacySettingsFinance passwordSettings = new PrivacySettingsFinance(); // Classe de consulta/atualização
