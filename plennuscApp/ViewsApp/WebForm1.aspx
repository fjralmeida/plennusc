<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="appWhatsapp.ViewsApp.WebForm1" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="<%= ResolveUrl("~/Content/Css/styleWebForm1.css") %>" />
            ...
            <section class="login-side">
                <div class="login-card">
                    <div class="login-header">
                        ...
                        <img src="../Uploads/logo_plennus_sb.png" class="logo-login"/>
