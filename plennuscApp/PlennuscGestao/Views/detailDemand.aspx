...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div class="container py-3">
                ...
                <p class="card-text">
                    <asp:Label ID="lblTexto" runat="server" 
                              style="color: #000000 !important; 
                                     ...
                                     visibility: visible !important;"></asp:Label>
                </p>
        ...
        <!-- Painel de Resposta (para destinatário) -->
        <asp:Panel ID="pnlResposta" runat="server" CssClass="card shadow-sm mb-3">
            <div class="card-header"><strong>💬 Responder Demanda</strong></div>
            <div class="card-body demand-reply">
                ...
                <asp:Button ID="btnResponder" runat="server" CssClass="btn btn-primary" Text="Enviar Resposta" OnClick="btnResponder_Click" />
            </div>
        </asp:Panel>

        <!-- NOVO: Painel de Reabertura (para solicitante) -->
        <asp:Panel ID="pnlReabertura" runat="server" CssClass="card shadow-sm mb-3" Visible="false">
            <div class="card-header"><strong>🔄 Reabrir Demanda</strong></div>
            <div class="card-body demand-reply">
                <asp:TextBox ID="txtMotivoReabertura" runat="server" CssClass="form-control mb-3" TextMode="MultiLine" Rows="4" placeholder="Digite o motivo da reabertura..."></asp:TextBox>
                <asp:Button ID="btnConfirmarReabertura" runat="server" CssClass="btn btn-warning" Text="Confirmar Reabertura" OnClick="btnConfirmarReabertura_Click" />
            </div>
        </asp:Panel>
