...
{
    public partial class viewDemandBeforeAcceptMedic : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    Response.Redirect("listDemandMedic.aspx");
                }
            }
        }
        ...
        private void CarregarAnexos()
        {
            ...
            if (anexos != null && anexos.Any())
            {
                rptAnexos.DataSource = anexos.Select(a => new
                {
                    ...
                    CaminhoDownload = $"/public/uploadmedic/docs/{a.NomeArquivo}",
        ...
        protected void btnAceitarDemanda_Click1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (aceitou)
                {
                    ...
                    Response.Redirect($"detailDemandMedic.aspx?codDemanda={CodDemanda}", false);
