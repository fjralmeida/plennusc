...
{
    public partial class employeeEditMedic : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("employeeManagementMedic.aspx");
            }
        ...
        {
            PessoaDAOMedic daoPessoa = new PessoaDAOMedic();
        ...
        {
            PessoaDAOMedic daoCargo = new PessoaDAOMedic();
        ...
        {
            PessoaDAOMedic daoDepartamento = new PessoaDAOMedic();
        ...
        protected void btnCriarLogin_Click(object sender, EventArgs e)
        {
            ...
            var authDao = new AutenticacaoDAOMedic();
            var pessoaDao = new PessoaDAOMedic();
        ...
        {
            var acessoDao = new AutenticacaoDAOMedic();
            ...
            try
            {
                ...
                if (novoId > 0)
                {
                    ...
                    <html>
                      <body>
                        <h2>Olá, {nome}!</h2>
                        <p>Seu acesso ao sistema Plennusc (https://plennusc.vallorbeneficios.com.br/) foi criado com sucesso.</p>
