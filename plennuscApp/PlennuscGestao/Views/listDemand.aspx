...
<style>
    ...
    /* IMPORTÂNCIA - CORREÇÃO DEFINITIVA */
    ...
    /* PRIORIDADE - CORREÇÃO DEFINITIVA */
    .prioridade-normal {
        background: #e8f5e9 !important;
        color: #2e7d32 !important;
        border: 1px solid #c8e6c9 !important;
    ...
    /* STATUS - CORREÇÃO DEFINITIVA - CORES ESCURAS LEGÍVEIS */
    ...
    .status-andament, .status-andament, .status-emandamento {
        background: #e3f2fd !important;
        color: #1565c0 !important;
        border: 1px solid #bbdefb !important;
    }
    ...
    /* FALLBACK PARA STATUS/PRIORIDADE/IMPORTÂNCIA DESCONHECIDOS */
    .badge:not([class*="status-"]):not([class*="prioridade-"]):not([class*="importancia-"]) {
    ...
    /* Colunas específicas */
    .col-id { width: 80px; }
    .col-titulo { width: 250px; min-width: 200px; }
    .col-categoria { width: 150px; }
    .col-subtipo { width: 150px; }
...
<asp:GridView ID="gvDemandas" runat="server" CssClass="custom-grid"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="DataSolicitacao" HeaderText="Data" DataFormatString="{0:dd/MM/yyyy}" 
            ItemStyle-CssClass="text-center col-data" HeaderStyle-CssClass="text-center" />
        ...
        <asp:TemplateField HeaderText="Prioridade" 
            ...
            <ItemTemplate>
                <span class='badge prioridade-<%# Eval("Prioridade").ToString().ToLower().Replace("é", "e").Replace("á", "a").Replace("í", "i").Replace("ê", "e").Replace("â", "a").Replace("ô", "o").Replace("û", "u").Replace("ç", "c") %>'>
                    <%# Eval("Prioridade") %>
                </span>
            </ItemTemplate>
        </asp:TemplateField>
